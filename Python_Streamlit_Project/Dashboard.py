...
if f1 is not None:
    ...
    os.chdir(r'C:\Users\bhava\OneDrive\Desktop\Bhavani-Data-Analytics-Portfolio\Python_Streamlit_Project')
...
with col1:
    date1=pd.to_datetime(st.date_input("Start_Date",Start_Date

with col2:
    date2=pd.to_datetime(st.date_input("End_Date",End_Date))
...
df2 = df2.rename(columns={"State/Province": "State"})
